...
const TopNavbar = () => {
  ...
  return (
    <nav className="sticky top-0 z-20">
      <div className={`max-w-frame mx-auto bg-white items-center py-5 md:py-6 transition-transform duration-300 shadow-sm px-6 xl:px-12 ${showHeader ? "translate-y-0" : "-translate-y-full"
        }`}>
        {/* <header
